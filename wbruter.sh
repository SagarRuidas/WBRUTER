...
if [[ $1 = "--android" && $2 = "4" ]] || [[ $1 = "-a" && $2 = "4" ]]; then
    ...
    multidevices
    android6
elif [[ $1 = "--androidg" && $2 = "4" ]] || [[ $1 = "-A" && $2 = "4" ]]; then
    androiddebug
    adbexist
    android_status
    multidevices
    androidgui4
elif [[ $1 = "--androidg" && $2 = "6" ]] || [[ $1 = "-A" && $2 = "6" ]]; then
    androiddebug
    adbexist
    android_status
    multidevices
...
cat << EOF
   ...
   ./wbruter.sh [option]  
       ...
       -a|--android  [4]              - Brute force attack the pin code with 4 digits. (cli)
       -a|--android  [6]              - Brute force attack the pin code with 4 digits. (cli)
       -A|--androidg [4]              - Brute force attack the pin code with 4 digits. (touch screen / gui) 
       -A|--androidg [6]              - Brute force attack the pin code with 4 digits. (touch screen / gui) 
